...
$stmt = $pdo->prepare("SELECT * FROM files WHERE expiry_time < :current_time AND is_guest = 1");
...
$stmt = $pdo->prepare("DELETE FROM files WHERE expiry_time < :current_time AND is_guest = 1");
$stmt->execute([':current_time' => $currentTimestamp]);
  ...
  body.dark-mode .cards .card1, body.dark-mode .card2,body.dark-mode .card3,body.dark-mode .card4{
                box-shadow: 9px 15px 1px 0px gray;   
   
        }
  body.dark-mode .cards .card1:hover, body.dark-mode .card2:hover,body.dark-mode .card3:hover,body.dark-mode .card4:hover {
        transform: translateY(-10px);  
        box-shadow: 9px 25px 1px 0px gray;   
        }
  ...
  <button id="accept-cookies" style="
    ...
    Kabul Et
        ...
        <div class="footer-nav"> 
            ...
            <li><a href="mailto:"><b>Email: </b>tefsharingt@gmail.com
            </a></li> 
            </ul>
        </div> 
