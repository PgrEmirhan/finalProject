    ...
    if ($fileError === 0) {
        ...
        if (in_array($fileExt, $allowed)) {
            if ($fileSize < 10000000) { 
                ...
                // expiry_time değerini 0 olarak ayarlıyoruz (süresiz dosya)
                $expiryTime = '0000-00-00 00:00:00'; // Süresiz dosya
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css">
  <header>
    ...
    <a href="index.php"><img src="logo.png" alt="" style="width: 80px; margin-top:3px;"></a>
      <ul> 
  ...
  <main>
    <div class="upload">
        <h2 style="font-size: 25px; ">Hoş geldiniz, <?php echo htmlspecialchars($username); ?>!</h2>   
           <img src="upload.png" alt="" width="240"><br>
...
function triggerFileInput() {
    document.getElementById('fileInput').click(); // input dosya seçme penceresini açar
}
