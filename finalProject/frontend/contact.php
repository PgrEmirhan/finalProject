...
<body>
  ...
  <header>
    <nav class="nav-container">
      <a href="index.php"><img src="images/logo.png" alt="" style="width: 80px; margin-left: 20px;"></a>
      <ul>
  ...
  <main>    
    <div class="container">
      ...
      <form action="login.php" method="post"> 
        <div class="kadi-icon">
      <input type="text" name="" id="kadi" placeholder="adınız..." style="width: 100%;"> <i class="fa-solid fa-user"></i></div>
        <div class="kadi-icon">
      <input type="text" name="" id="email" placeholder="mail adresiniz..." style="width: 100%;"> <i class="fa-solid fa-envelope"></i></div>
        <div>
        <textarea name="" id="" cols="54" rows="10" placeholder="mesajınız..."></textarea>
        </div>
          <input type="button" value="Gönder" id="gonder-btn">
  ...
  <footer>  
   ...
   const togglePassword = document.getElementById("togglePassword");
        ...
        togglePassword.addEventListener("click", function () {
            // Şifreyi görünür hale getirme/gizleme
            const type = passwordField.type === "password" ? "text" : "password";
            passwordField.type = type;

            // Göz simgesini değiştirme
            this.classList.toggle("fa-eye"); // göz simgesini göster
            this.classList.toggle("fa-eye-slash"); // göz simgesini gizle
        });
