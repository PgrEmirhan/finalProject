...
if (isset($_POST['username']) && isset($_POST['password'])) {
    $input_username = trim($_POST['username']);  // Kullanıcı adını temizle
    $input_password = $_POST['password'];         // Şifreyi al

    // Kullanıcı adıyla veritabanından kullanıcıyı sorgula
    ...
    if ($user && password_verify($input_password, $user['user_password'])) {
        ...
        // Giriş başarılı, upload.php'ye yönlendir
